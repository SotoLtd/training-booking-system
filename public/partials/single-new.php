                                            ...
                                            <div class="course-sbelement course-certification">
                                                ...
                                                <div class="course-sbelement-content">
													<?php if ( $the_course->certification_logo ) { ?>
                                                        <p class="course-certification-logo">
                                                            <img src="<?php echo esc_url( $the_course->certification_logo ); ?>" alt=""/>
                                                        </p>
													<?php } ?>
                                        ...
                                        <div class="course-normal-text course-traingin-status">
											...
											if ( count( $course_dates > 0 ) ) {
												tbs_get_template_part( 'course-date-loop', true, array(
													...
													'hide_table_filter' => (bool) $queried_date
												) );
											}
											?>
                                        </div>
													...
													<?php foreach ( $the_course->testimonials as $testimonial ) { ?>
                                                        <div class="course-testimonial">
															...
															<?php if ( ! empty( $testimonial['testimonial'] ) ) { ?>
                                                                <div class="course-testimonial-text">
                                                                    ...
                                                                    <div class="course-testimonial-author-details">
                                                                        <p class="ctad-author-name-job-title">
																			...
																			<?php if ( ! empty( $testimonial['job_title'] ) ) {
																				echo ' - ' . $testimonial['job_title'];
																			} ?>
                                                                        </p>
                                                                ...
                                                                <div class="course-testimonial-author-image"><?php if ( ! empty( $testimonial['photo'] ) ) {
																		echo '<img alt="" src="' . esc_url( $testimonial['photo'] ) . '" />';
																	} ?></div>
															<?php } ?>
...
function tts_yanda_metrica() {
    ...
    <script type="text/javascript"> (function (d, w, c) {
            (w[c] = w[c] || []).push(function () {
                try {
                    w.yaCounter42342714 = new Ya.Metrika({
                        id: 42342714,
                        clickmap: true,
                        trackLinks: true,
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/42342714" style="position:absolute; left:-9999px;" alt=""/></div>
    </noscript>
